class Requests::Transferences::Finished::ComponentsController < ApplicationController
  ...
  def list
    ...
    @requests_transferences_finished_components = Requests::Transferences::Finished::Component.paginate(:page => params[:page], :order => "created_at DESC")
  end
  ...
  def index
    ...
    respond_to do |format|
      format.js
      format.pdf {
        @requests_transferences_finished_components = Requests::Transferences::Finished::Component.paginate(:page => params[:page], :per_page => MAX_PER_PAGE)
