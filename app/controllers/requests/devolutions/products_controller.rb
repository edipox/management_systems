class Requests::Devolutions::ProductsController < ApplicationController
  ...
  def list
    ...
    @requests_devolutions_products = Requests::Devolutions::Product.paginate(:page => params[:page], :order => "created_at DESC")
  end

  def index
    list  
    @title = "Pedidos de devoluci&oacute;n de productos"
    respond_to do |format|
      format.js
      format.pdf {
        @requests_devolutions_products = Requests::Devolutions::Product.paginate(:page => params[:page], :per_page => MAX_PER_PAGE)
