...
class ComponentesControllerTest < ActionController::TestCase
  ...
  test "should create componente" do
    assert_difference('Componente.count') do
      post :create, componente: { categoria: @componente.categoria, codigo: @componente.codigo, descripcion: @componente.descripcion, nombre: @componente.nombre }
    end
  ...
  test "should update componente" do
    put :update, id: @componente, componente: { categoria: @componente.categoria, codigo: @componente.codigo, descripcion: @componente.descripcion, nombre: @componente.nombre }
    assert_redirected_to componente_path(assigns(:componente))
  end
